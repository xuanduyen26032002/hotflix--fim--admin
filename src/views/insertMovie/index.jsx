...
import { insertMovie } from "../../store/actions/movies";
...
const InsertMovie = (props) => {
  ...
  const handleSubmit = (event) => {
    ...
    insertMovie(newMovie, accessToken, props);
  };
    ...
    <Layout>
      <div className="container-fluid">
        <div className="row py-3">
          <span className="fs-2 fw-bolder">Insert Movie</span>
        </div>
        <div className="row my-3">
          <form className="col-12 row">
            <div className="col-4 my-2">
              ...
              <img alt="hinhAnh" src={values.hinhAnh} className="w-100 my-4"></img>
            </div>
              ...
              <div className="col-12 row my-2">
                ...
                <div className="col-8 d-flex justify-content-between">
                  ...
                  <input
                    ...
                    value={values.ngayKhoiChieu.substr(0, 10)}
                    onChange={handleChange}
                    onBlur={handleBlur}
                  ></input>
